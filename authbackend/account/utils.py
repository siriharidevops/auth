...
def send_otp(mobile, otp):
    ...
    payload = ""
    # headers = {'content-type': 'application/x-www-form-urlencoded'}
    url = f"https://www.fast2sms.com/dev/bulkV2?authorization=UqS8jzhtyvmC7wInJZaLc3foOK4Wd260iHN1YuFQBgPpkEV59DFaGBIl3U6oVSMb9CRAsJOtLp0vz14n&route=otp&variables_values=1234&flash=0&numbers=8179839916"
